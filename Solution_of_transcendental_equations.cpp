...
// Solution_of_transcendental_equations.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CSolutionoftranscendentalequationsApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CSolutionoftranscendentalequationsApp

CSolutionoftranscendentalequationsApp::CSolutionoftranscendentalequationsApp()
{
...
// Единственный объект CSolutionoftranscendentalequationsApp

CSolutionoftranscendentalequationsApp theApp;


// Инициализация CSolutionoftranscendentalequationsApp

BOOL CSolutionoftranscendentalequationsApp::InitInstance()
{
	...
	CSolutionoftranscendentalequationsDlg dlg;
	m_pMainWnd = &dlg;
